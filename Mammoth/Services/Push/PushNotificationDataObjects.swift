...
public struct PushNotificationAlerts: Codable, Equatable {
    ...
    public static var all = PushNotificationAlerts(favourite: true, follow: true, mention: true, reblog: true, poll: true, status: true, followRequest: true)
	...
	public var isActive: Bool {
		return favourite || follow || mention || reblog || poll || status || followRequest
	}
}
